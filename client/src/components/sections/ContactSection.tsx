          ...
          >
            ...
            <div className="border-l-2 border-[#d4a853] pl-5 py-2">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <UserCheck className="w-3.5 h-3.5 text-[#d4a853] shrink-0 mt-0.5" />
                  <p className="text-xs text-[#0a1628]/50"><strong className="text-[#0a1628]">Feste Ansprechpartner</strong></p>
                </li>
                <li className="flex items-start gap-2">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 md:p-10 border border-[#0a1628]/5 hover:border-[#d4a853]/20 transition-colors duration-500">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-[#0a1628]/10 bg-transparent text-[#0a1628] text-sm
                      focus:outline-none focus:border-[#d4a853] transition-colors duration-300
                      placeholder:text-[#0a1628]/25"
                    placeholder="Max"
                  />
                </div>
                <div>
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border border-[#0a1628]/10 bg-transparent text-[#0a1628] text-sm
                    focus:outline-none focus:border-[#d4a853] transition-colors duration-300 resize-none
                    placeholder:text-[#0a1628]/25"
